function DefenderRow({defender, handleClick}) {
    ...
    return(
        <tr className="outline-1 outline h-12 font-semibold">
            ...
            <td className="px-2">
                <button className=" transition bg-blue-500 hover:bg-emerald-500 text-xs text-white font-bold py-1 px-2 rounded" onClick={() => handleClick(defender)}><a href="/squad">Choose</a></button>
            </td>
        </tr>
    )
}  
