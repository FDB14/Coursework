const DefenderRow = ({defender, handleClick}) => {
    return(
        <tr className="outline-1 outline">
            ...
            <td className="px-2">
                <a href="/squad"><button className="bg-blue-500 hover:bg-blue-700 text-xs text-white font-bold py-1 px-2 rounded" onClick={(event) => handleClick(event, defender)}>Choose</button></a>
            </td>
        </tr>
    )
}  
